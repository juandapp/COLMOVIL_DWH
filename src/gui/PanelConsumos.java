...
import logica.LogicaConsumos;

public class PanelConsumos extends javax.swing.JPanel {

    private LogicaConsumos logicaConsumos;
    ...
    public PanelConsumos(MainFrame parent) {
        ...
        jComboBoxDimensiones1.setModel(new javax.swing.DefaultComboBoxModel(logicaConsumos.getDataComboBoxDimensiones1()));
        jComboBoxAtributos1.setModel(new javax.swing.DefaultComboBoxModel(logicaConsumos.getDataComboBoxAtributos1(0)));
        jComboBoxHechos1.setModel(new javax.swing.DefaultComboBoxModel(logicaConsumos.getDataComboBoxHechos1()));

        jComboBoxDimensionesA.setModel(new javax.swing.DefaultComboBoxModel(logicaConsumos.getDataComboBoxDimensionesA()));
        jComboBoxAtributosA.setModel(new javax.swing.DefaultComboBoxModel(logicaConsumos.getDataComboBoxAtributosA(0)));
        jComboBoxDimensionesB.setModel(new javax.swing.DefaultComboBoxModel(logicaConsumos.getDataComboBoxDimensionesB()));
        jComboBoxAtributosB.setModel(new javax.swing.DefaultComboBoxModel(logicaConsumos.getDataComboBoxAtributosB(0)));
    ...
    private void jButtonBarJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBarJoinActionPerformed
        ...
        BarChart barChart = logicaConsumos.reporteUnParametroJoinBarra(dimension, atributo);
        addChartPanelInsideInternalFrame(barChart.getChartPanel(),barChart.getCharTitle());
    ...
    private void jButtonPieJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPieJoinActionPerformed
        int dimension = jComboBoxDimensiones.getSelectedIndex();
        int atributo = jComboBoxAtributos.getSelectedIndex();
        PieChart pieChart = logicaConsumos.reporteUnParametroJoinPie(dimension, atributo);
        addChartPanelInsideInternalFrame(pieChart.getChartPanel(), pieChart.getCharTitle());
    ...
    private void jComboBoxDimensionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxDimensionesActionPerformed
        int dimension = jComboBoxDimensiones.getSelectedIndex();
        Object[] atributosInteresantes = logicaConsumos.getDataComboBoxAtributos(dimension);
    ...
    private void jComboBoxDimensionesAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxDimensionesAActionPerformed
        ...
        Object[] atributosInteresantes = logicaConsumos.getDataComboBoxAtributosA(dimension);
    ...
    private void jButtonBarJoin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBarJoin1ActionPerformed
        ...
        BarChart barChart = logicaConsumos.reporteBiDimensionalBarra(dimensionA, atributoA, valorA, dimensionB, atributoB, valorB);
        addChartPanelInsideInternalFrame(barChart.getChartPanel(), barChart.getCharTitle());
    ...
    public void maximizarTodos() {
        ...
        for (int i = 0; i < allframes.length; i++) {
            try {
                ...
                Logger.getLogger(PanelConsumos.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        tileInternalframes();
    }
    ...
    private void loadDatajComboBoxValores() {
        int dimension = jComboBoxDimensiones1.getSelectedIndex();
        int atributo = jComboBoxAtributos1.getSelectedIndex();
        Object[] valores = logicaConsumos.getDataComboBoxValores(dimension, atributo);
    ...
    private void loadDatajComboBoxValoresA() {
        ...
        Object[] valores = logicaConsumos.getDataComboBoxValoresA(dimension, atributo);
    ...
    private void loadDatajComboBoxValoresB() {
        ...
        Object[] valores = logicaConsumos.getDataComboBoxValoresB(dimension, atributo);
