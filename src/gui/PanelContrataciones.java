...
import logica.LogicaContrataciones;

public class PanelContrataciones extends javax.swing.JPanel {

    private LogicaContrataciones logicaContrataciones;
    private MainFrame parent;

    public PanelContrataciones(MainFrame parent) {
        this.parent = parent;
        logicaContrataciones = new LogicaContrataciones();
        initComponents();

        jComboBoxHechos.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxHechos()));

        jComboBoxDimensiones.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxDimensiones()));
        jComboBoxAtributos.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxAtributos(0)));

        jComboBoxDimensiones1.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxDimensiones1()));
        jComboBoxAtributos1.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxAtributos1(0)));
        jComboBoxHechos1.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxHechos1()));

        jComboBoxDimensionesA.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxDimensionesA()));
        jComboBoxAtributosA.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxAtributosA(0)));
        jComboBoxDimensionesB.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxDimensionesB()));
        jComboBoxAtributosB.setModel(new javax.swing.DefaultComboBoxModel(logicaContrataciones.getDataComboBoxAtributosB(0)));
    ...
    private void jButtonPieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPieActionPerformed
        ...
        PieChart pieChart = logicaContrataciones.reporteUnParametroPie(hecho);
    ...
    private void jButtonBarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBarActionPerformed
        final int hecho = jComboBoxHechos.getSelectedIndex();
        BarChart barChart = logicaContrataciones.reporteUnParametroBarra(hecho);
    ...
    private void jButtonBarJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBarJoinActionPerformed
        ...
        BarChart barChart = logicaContrataciones.reporteUnParametroJoinBarra(dimension, atributo);
        addChartPanelInsideInternalFrame(barChart.getChartPanel(),barChart.getCharTitle());
    ...
    private void jButtonPieJoinActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPieJoinActionPerformed
        int dimension = jComboBoxDimensiones.getSelectedIndex();
        int atributo = jComboBoxAtributos.getSelectedIndex();
        PieChart pieChart = logicaContrataciones.reporteUnParametroJoinPie(dimension, atributo);
        addChartPanelInsideInternalFrame(pieChart.getChartPanel(), pieChart.getCharTitle());
    ...
    private void jComboBoxDimensionesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxDimensionesActionPerformed
        int dimension = jComboBoxDimensiones.getSelectedIndex();
        Object[] atributosInteresantes = logicaContrataciones.getDataComboBoxAtributos(dimension);
    ...
    private void jComboBoxDimensionesAActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxDimensionesAActionPerformed
        ...
        Object[] atributosInteresantes = logicaContrataciones.getDataComboBoxAtributosA(dimension);
    ...
    private void jButtonBarJoin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBarJoin1ActionPerformed
        ...
        BarChart barChart = logicaContrataciones.reporteBiDimensionalBarra(dimensionA, atributoA, valorA, dimensionB, atributoB, valorB);
        addChartPanelInsideInternalFrame(barChart.getChartPanel(), barChart.getCharTitle());
    ...
    private void jComboBoxDimensiones1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxDimensiones1ActionPerformed
        ...
        Object[] atributosInteresantes = logicaContrataciones.getDataComboBoxAtributos1(dimension);
    ...
    private void jButtonBarJoin2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonBarJoin2ActionPerformed
        ...
        BarChart barChart = logicaContrataciones.reporteBivariadoBarra(dimension, atributo, valor, hecho);
        addChartPanelInsideInternalFrame(barChart.getChartPanel(), barChart.getCharTitle());
    ...
    private void jComboBoxDimensionesBActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jComboBoxDimensionesBActionPerformed
        ...
        Object[] atributosInteresantes = logicaContrataciones.getDataComboBoxAtributosB(dimension);
    ...
    private void jButtonPieJoin2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPieJoin2ActionPerformed
        ...
        int atributo = jComboBoxAtributos1.getSelectedIndex();
        String valor = jComboBoxValores.getSelectedItem().toString();
        MultiplePieChart multiplePieChart = logicaContrataciones.reporteBivariadoPie(dimension, atributo, valor, hecho);
    ...
    private void jButtonPieJoin1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonPieJoin1ActionPerformed
        ...
        MultiplePieChart multiplePieChart = logicaContrataciones.reporteBiDimensionalPie(dimensionA, atributoA, valorA, dimensionB, atributoB, valorB);
        addChartPanelInsideInternalFrame(multiplePieChart.getChartPanel(), multiplePieChart.getCharTitle());
    ...
    public void maximizarTodos() {
        ...
        for (int i = 0; i < allframes.length; i++) {
            try {
                ...
                Logger.getLogger(PanelContrataciones.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
        tileInternalframes();
    }
    ...
    private void loadDatajComboBoxValores() {
        int dimension = jComboBoxDimensiones1.getSelectedIndex();
        int atributo = jComboBoxAtributos1.getSelectedIndex();
        Object[] valores = logicaContrataciones.getDataComboBoxValores(dimension, atributo);
    ...
    private void loadDatajComboBoxValoresA() {
        ...
        Object[] valores = logicaContrataciones.getDataComboBoxValoresA(dimension, atributo);
    ...
    private void loadDatajComboBoxValoresB() {
        ...
        Object[] valores = logicaContrataciones.getDataComboBoxValoresB(dimension, atributo);
