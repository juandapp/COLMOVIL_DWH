...
public class ControladorContrataciones {

    private final FachadaBD fachadaBD;

    public ControladorContrataciones() {
    ...
    public String[][] reporteUnParametroPie(String parametro) {
        ...
        try {
            ...
            String consulta = "SELECT " + parametro + ", COUNT( " + parametro + " ) FROM  Contrataciones GROUP BY " + parametro;
            System.out.println(consulta);
    ...
    public String[][] reporteUnParametroBarra(String parametro) {
        ...
        try {
            ...
            String consulta = "SELECT COUNT( " + parametro + " ), " + parametro + "  FROM  Contrataciones GROUP BY " + parametro;
            System.out.println(consulta);
